...
# Public subnets — the ALB (load balancer) lives here
...
# Private subnets — EKS nodes live here (no direct internet access)
...
# Internet Gateway — lets the public subnets reach the internet
